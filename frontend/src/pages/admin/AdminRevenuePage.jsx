    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 animate-fade-in">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Financial breakdown by event</p>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-gray-500 font-medium">Events Tracked</span>
          </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-100">
          <h2 className="font-semibold text-gray-900">Revenue by Event</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="p-12 text-center text-gray-400">No revenue data yet</div>
        ) : (
                ...
                <div key={event.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="hidden sm:block text-center flex-shrink-0">
                      <p className="font-semibold text-gray-900">{event.confirmed_count}/{event.capacity}</p>
                    ...
                    <div className="text-right flex-shrink-0">
                      <p className="font-bold text-emerald-600">₹{event.revenue.toLocaleString('en-IN')}</p>
                      <p className="text-xs text-gray-400">revenue</p>
                    </div>
                    <Link
                      to={`/admin/attendees/${event.id}`}
                      className="p-2 hover:bg-violet-50 rounded-lg transition-colors flex-shrink-0"
                    >
